;(function(root, factory) {
	...
	var CitySelector = function(parentEl, options) {
		...
		this.els = {}
		this.actionName = options.actionName || { title: "请选择地区", cancelBtn: "取消", confirmBtn: "确认" }
		this.tabs = options.tabs || ["请选择", "请选择", "请选择"]
		this.data = options.defaultData || { province: "", city: "", district: "" }
		this.errorTips = options.errorTips || {
			noPro: "请选择省份",
			noCity: "请选择城市",
			noDis: "请选择区域"
		}
